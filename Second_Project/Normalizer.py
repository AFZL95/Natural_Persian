...
#norm_accents is the vowel letters in arabic and some other symbols like "La"
norm_accents = re.compile(ur'[\u0610\u0611\u0612\u0613\u0614\u0615\u0616\u0617\u0618\u0619\u061a\u064b\u064c\u064d\u064e\u064f\u0650\u0651\u0652\u0653\u0654\u0655\u0656\u0657\u0658\u0659\u065a\u065b\u065c\u065d\u065e\u065f\u0670\u06d6\u06d7\u06d8\u06d9\u06da\u06db\u06dc\u06df\u06e0\u06e1\u06e2\u06e3\u06e4\u06e7\u06e8\u06ea\u06eb\u06ec\u06ed]',flags=re.U)
#numerals are the unicode equivalent of arabic ( or persian insatiably) numbers
...
#some other redundant letters
letters = {ur'\u0622':ur'\u0627',ur'\u0623':ur'\u0627',ur'\u0625':ur'\u0627',ur'\u0624':ur'\u0648',ur'\u0626':ur'\u064a',ur'\06c0':ur'\u0674'}

#Normalize Farsi text string by removing diacritics, replacing diacriticized 'alef','he','ye','vav' and 'ke' with standard versions
#and finally converting Unicode numerals to Western numerals
def norm_farsi(farsiString, ar=False, ellipsis=False):
	#Strip whitespace, ZWNJ, and non-break space from farsiString
	#it's for adjusting the spacing between the words like "mi shavad!"
	...
	if ar:
		...
		farsiString = re.sub(ur'\u063d\b', ur'\u0649', farsiString, flags=re.U)
		farsiString = re.sub(ur'\u063e\b', ur'\u0649', farsiString, flags=re.U)
		
		#Normilize Frasi keheh
		farsiString = re.sub(ur'\u063B', ur'\06a9', farsiString, flags=re.U)
		farsiString = re.sub(ur'\uFB8E', ur'\06a9', farsiString, flags=re.U)
		#Normilizing Arabic Teh marbuta to persian normal Heh
		farsiString = re.sub(ur'\u0629', ur'\u0647', farsiString, flags=re.U)
		farsiString = re.sub(ur'\uFE94', ur'\u0647', farsiString, flags=re.U)
	...
	#Optional: normalize ellipsis (sequence of full stops becomes ellipsis) (in other words ellipsis is the "..." symbol)
	if ellipsis:
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Normalize Farsi and Arabic text.')
